...
public class BackupMethods {
  ...
  public BackupMethods(
      GoogleDriveBackupMethod googleDrive,
      OneDriveBackupMethod oneDrive,
      DropboxBackupMethod dropbox,
      WebDAVBackupMethod webdav,
      NextcloudBackupMethod nextcloud,
      S3BackupMethod s3,
      FTPBackupMethod ftp) {
  ...
  public static BackupMethods parse(@NotNull FileConfiguration config, Logger logger) {
    ...
    OneDriveBackupMethod oneDriveMethod =
        new OneDriveBackupMethod(config.getBoolean("onedrive.enabled"));
    DropboxBackupMethod dropboxMethod =
        new DropboxBackupMethod(config.getBoolean("dropbox.enabled"));
    WebDAVBackupMethod webdavMethod = new WebDAVBackupMethod(
        ...
        config.getString(
            "webdav.remote-save-directory", config.getString("remote-save-directory")));
    NextcloudBackupMethod nextcloudMethod = new NextcloudBackupMethod(
        ...
        config.getString(
            "nextcloud.remote-save-directory", config.getString("remote-save-directory")),
