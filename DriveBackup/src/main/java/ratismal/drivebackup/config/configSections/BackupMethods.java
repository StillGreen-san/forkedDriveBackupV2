...
public class BackupMethods {
    ...
    public BackupMethods(GoogleDriveBackupMethod googleDrive, OneDriveBackupMethod oneDrive,
            DropboxBackupMethod dropbox, WebDAVBackupMethod webdav, NextcloudBackupMethod nextcloud, S3BackupMethod s3,
            FTPBackupMethod ftp) {
    ...
    public static BackupMethods parse(@NotNull FileConfiguration config, Logger logger) {
        ...
        return new BackupMethods(googleDriveMethod, oneDriveMethod, dropboxMethod, webdavMethod, nextcloudMethod,
                s3Method, ftpMethod);
    }
}
