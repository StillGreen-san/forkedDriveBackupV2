...
public class DriveBackupApi {
    ...
    static boolean shouldStartBackup() {
        ...
        for (Future<Boolean> future : futures) {
            try {
                ...
                MessageUtil.Builder()
                        .text("Failed to execute a beforeBackupStart() Callable, ignoring")
                        .toConsole(true)
                        .send();
     ...
     * <p>
     * For more information about the {@code /drivebackup nextbackup} command, see <a
     * href="https://github.com/MaxMaeder/DriveBackupV2/wiki/Commands#drivebackup-nextbackup">this</a>
     *
     * @return the message
     */
